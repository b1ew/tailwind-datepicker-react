		...
		<>
			{children ? (
				...
				<div className="relative">
					...
					<Input ref={InputRef} nameProp={options?.inputNameProp} placeholder={options?.placeholder} />
				</div>
			)}
...
const Input = forwardRef<HTMLInputElement, { nameProp?: string, placeholder?: string }>((props, ref) => {
